    ...
    return (
        <div class="w-60 m-5 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-col items-center pb-10">
                <h2 class="mt-8 text-md font-medium text-gray-900 dark:text-white">Id: {id}</h2>
                <h2 class="mb-1 text-md font-medium text-gray-900 dark:text-white">Producto: {nombre}</h2>
                <h2 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Stock: {stock}</h2>
                <span class="text-sm text-gray-500 dark:text-gray-400">{descripcion}</span>
