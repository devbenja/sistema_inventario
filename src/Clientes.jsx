                        ...
                        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50 modal-backdrop bg-black bg-opacity-50">
                            <div className="bg-white p-8 rounded-lg shadow-lg w-2/5 mx-auto mb-60">
                                ...
                                <form onSubmit={handleFormSubmit}>
                                    <div className="mb-4">
                                        <label className="block text-gray-700 font-bold mb-2" htmlFor="name">Nombre Cliente</label>
                                        <input
                                            type="text"
                                            id="name"
                                            value={nombreCliente}
                                    ...
                                    <div className="mb-7">
                                        <label className="block text-gray-700 font-bold mb-2" htmlFor="email">Telefono Cliente</label>
                                        <input
                                            type="text"
                                            id="email"
                ...
                <div className='flex flex-wrap justify-center w-full'>
                    {
                        clientes.map(cliente => (
                            <CardsCliente setCardUpdate={setCardUpdate} key={cliente.IdCliente} id={cliente.IdCliente} nombre={cliente.NombreCliente} telefono={cliente.TelefonoCliente} />
                        ))
                    }
                </div>
            </div>
