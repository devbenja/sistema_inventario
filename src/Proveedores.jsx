...
export const Proveedores = () => {
    ...
    const handleFormSubmit = async (event) => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/CrearProveedor', {
                method: 'POST',
                headers: {
    ...
    const results = !search ? proveedores : proveedores.filter((dato) => dato.NombreProveedor.toLowerCase().includes(search.toLowerCase()))
        ...
        <div>
            ...
            <div className="border p-10">
                <div className="flex flex-wrap gap-5 justify-around items-center mb-4 w-full">
                    <p className="text-xl font-medium">Proveedores</p>
                    <div className="flex gap-5 justify-around flex-wrap items-center">
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input onChange={handleSearch} value={search} type="text" id="simple-search" class="bg-gray-50 border border-gray-300 w-full text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 blockw-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required />
                            </div>
                        </form>
                    ...
                    </thead>
                    {
                        results.map(proveedor => (
                            <CardsProveedores
                                ...
                                correo={proveedor.CorreoProveedor}
                                localidad={proveedor.Pais}
                            />
                        ))
                    }
                </table>
