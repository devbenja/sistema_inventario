                ...
                <div className="p-20">
                    ...
                    <form onSubmit={handleFormSubmit} className='p-10'>
                        {mostrarAlertaExitosa && (
                            <div className="mt-5 flex bg-green-100 rounded-lg p-4 mb-10 text-sm text-green-700" role="alert">
                        ...
                        {mostrarAlertaError && (
                            ...
                            <div className="mt-6 flex bg-red-100 rounded-lg p-4 mb-10 text-sm text-red-700" role="alert">
                                <svg className="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                                <div>
                        ...
                        <div className="mb-4">
                            <label className="block text-gray-700 font-medium mb-2" htmlFor="country">Proveedor</label>
                            <select
                                id="country"
                        ...
                        <div className="mb-4">
                            <label className="block text-gray-700 font-medium mb-2" htmlFor="city">Producto</label>
                            <select
                                id="city"
                                className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500"
                                value={idProduct}
                        ...
                        <div className="mb-4">
                            <label className="block text-gray-700 font-medium mb-2" htmlFor="name">Cantidad</label>
                            <input
                                value={cantidad}
